...
def compute_a2(z2):
    ...
    for i in range(zShape):
        if z2[i] > 100:
            ...
            ZeroArr[i][0] = math.exp(z2[i])
    a2 = np.mat(ZeroArr / np.sum(ZeroArr))
    #########################################
    return a2 
